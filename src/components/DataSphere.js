      ...
      sap.ui.define([
        ...
        return Controller.extend("ifm.datasphere", {
          ...
          onPress: function (oEvent) {
            const authURL = encodeURI(`${that_._export_settings.DSP_oAuthURL}?response_type=code&client_id=${that_._export_settings.DSP_clientID}&redirect_uri=localhost`); //encodeURI() &redirect_uri=${that_._export_settings.DSP_redirectURL}
